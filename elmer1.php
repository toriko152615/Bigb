...
if (isset($_SESSION['user_id'])) {
  header("Location: elmer2.php"); // Redirect to dashboard if logged in
  exit();
}
...
<form class="container552" id="insertForm" class="modal-content animate" method="post">
  <center>
   ...
   <label for="email"><b>First Name </b></label>
	...
	<input class="button256789 button154" type="date" placeholder="Date of Birth" name="dateOfBirth" required>
  <br>
...
<br>
<br>
<label class="label2">IT'S MORE FUN IN BIGBREW!!!</label>
<br>
<br>
<center>
